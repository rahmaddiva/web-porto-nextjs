  ...
  return (
    <section id="contact" className="relative w-full py-28 md:py-40 px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        <Reveal>
          <p className="font-display text-sm tracking-[0.25em] uppercase text-muted mb-12 text-center">
            04 — Contact
          </p>
        </Reveal>

        <div className="grid grid-cols-1 md:grid-cols-[240px_1fr] gap-10 md:gap-14 items-center">
          <Reveal>
            <figure className="mx-auto md:mx-0 w-52 md:w-full">
              <img
                src={PHOTO_SRC}
                alt="Portrait of Rahmad Diva"
                className="aspect-[4/5] w-full object-cover object-top rounded-2xl border border-line grayscale hover:grayscale-0 transition-all duration-500"
              />
              <figcaption className="mt-3 text-center font-display text-sm text-muted">
                Rahmad Diva — Tanah Laut, ID
              </figcaption>
            </figure>
          </Reveal>
          ...
          <div>
            <Reveal delay={0.1}>
              <h2 className="font-display font-bold tracking-[-0.03em] leading-[1.02] text-[clamp(2rem,6vw,3.75rem)] mb-8">
                Have something
                <br />
            ...
            <Reveal delay={0.2}>
              <a
                ...
                className="group inline-flex items-baseline gap-3 font-display font-medium text-lg md:text-xl"
              >
