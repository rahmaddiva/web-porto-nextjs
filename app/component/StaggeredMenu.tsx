...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  const toggleMenu = useCallback(() => {
    ...
    className =
      "staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-[2em] bg-transparent z-20";
  ...
  return (
    <div
      className={`sm-scope z-40 sticky top-0 w-full h-20`}
      style={{ height: "5rem" }}
    >
      <div
        className={
          (className ? className + " " : "") +
          "staggered-menu-wrapper sticky top-0 w-full h-20 z-40"
        }
        style={
          accentColor
      ...
      >
        ...
        <aside
          ...
          ref={panelRef}
          className={`staggered-menu-panel absolute top-0 right-0 h-screen flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] ${
            open ? "bg-[#232323]/90" : "bg-transparent"
          }`}
          style={{ WebkitBackdropFilter: "blur(12px)", height: "100vh" }}
          aria-hidden={!open}
        >
